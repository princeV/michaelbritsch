...
"use strict";angular.module("pictures").run(["Menus",function(Menus){Menus.addMenuItem("topbar",{title:"Pictures",isPublic:!0,state:"pictures",type:"dropdown"}),Menus.addSubMenuItem("topbar","pictures",{title:"List Pictures",isPublic:!0,state:"pictures.list"}),Menus.addSubMenuItem("topbar","pictures",{title:"Create Picture",isPublic:!1,roles:["test"],state:"pictures.create"}),Menus.addSubMenuItem("topbar","pictures",{title:"TEst Picture",isPublic:!1,roles:["user"],state:"pictures.create"})}]);

...
exports.list = function (req, res) {
    Biography.find().sort('-created').populate('user', 'displayName').exec(function (err, biographies) {
        if (err) {
            return res.status(400).send({
                message: errorHandler.getErrorMessage(err)
            });
 ...
 */
exports.biographyByID = function (req, res, next, id) {
    Biography.findById(id).populate('user', 'displayName').exec(function (err, biography) {

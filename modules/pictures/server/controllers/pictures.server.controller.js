...
exports.delete = function (req, res) {
	...
	for (i = 0; i < picture.sizes.length; i++) {
		var deleteGridFsRecord = {
			fileId: picture.sizes[i].files_id,
			/* jshint loopfunc:true */
			removePicture: function (callback) {
				// remove the gridFS file via id:
		...
		waterfallFunctions.push(deleteGridFsRecord.removePicture.bind(deleteGridFsRecord));
	}
...
exports.uploadImage = function (req, res) {
	...
	async.waterfall([
		...
		function createSquareImageBuffer(image, callback) {
			//calculate the image height:
			var imageSquareSize = {width: 75, height: 75};
